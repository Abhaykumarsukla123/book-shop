  ...
  <div className="mx-auto md:w-2/3 lg:w-1/2">
    <div className="-m-2 flex flex-wrap">
      ...
      <div className="w-full p-2">
        <button className="mx-auto flex rounded border-0 bg-indigo-500 py-2 px-8 text-lg text-white hover:bg-indigo-600 focus:outline-none">Send To</button>
      </div>
      ...
      <div className="mt-8 w-full border-t border-gray-800 p-2 pt-8 text-center">
        <h1>Contact Us</h1>
        <a className="text-indigo-400">abhayshukla7238@gmail.com</a><br/>Mob.no-7238871336.
        <p className="my-5 leading-normal">Suraj Pur Greater Noida. <br />Uttar Pradesh, Pin 201309</p>
