...
export default function Footer() {
  return (
    <>
    <footer className="text-slate-400 m-4 ">
  
  <div className="pt-16 pb-12 text-sm border-t border-slate-900 bg-red-800">
    <div className="container px-6 mx-auto">
      <div className="grid grid-cols-4 gap-6 md:grid-cols-8 lg:grid-cols-12">
        <nav className="col-span-2 md:col-span-4 lg:col-span-3" aria-labelledby="footer-product-dark">
          <h3 className="mb-6 text-base font-medium text-white" id="footer-product-dark">Product</h3>
          <ul>
        ...
        <nav className="col-span-2 md:col-span-4 lg:col-span-3" aria-labelledby="footer-docs-dark">
          <h3 className="mb-6 text-base font-medium text-white" id="footer-docs-dark">Docs & help</h3>
          <ul>
            <li className="mb-2 leading-6">
        ...
        <nav className="col-span-2 md:col-span-4 lg:col-span-3" aria-labelledby="footer-about-dark">
          <h3 className="mb-6 text-base font-medium text-white" id="footer-about-dark">About us</h3>
          <ul>
            <li className="mb-2 leading-6">
        ...
        <nav className="col-span-2 md:col-span-4 lg:col-span-3" aria-labelledby="footer-get-in-touch-dark">
          <h3 className="mb-6 text-base font-medium text-white" id="footer-get-in-touch-dark">Get in touch</h3>
          <ul>
            <li className="mb-2 leading-6">
      ...
      <div className="grid grid-cols-4 gap-6 md:grid-cols-8 lg:grid-cols-12">
        ...
        <nav aria-labelledby="footer-social-links-dark" className="col-span-2 text-right md:col-span-4 lg:col-span-6">
          ...
          <ul className="flex items-center justify-end gap-4">
            <li>
              <a href="javascript:void(0)" className="transition-colors duration-300 hover:text-emerald-500">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 48 48" height="16" width="16" className="w-4 h-4 shrink-0" role="graphics-symbol" aria-labelledby="title-tb01-dark desc-tb01-dark">
                  <title id="title-tb01-dark">Icon title</title>
                  <desc id="desc-tb01-dark">A more detailed description of the icon</desc>
            ...
            <li>
              <a href="javascript:void(0)" className="transition-colors duration-300 hover:text-emerald-500">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 48 48" height="16" width="16" className="w-4 h-4 shrink-0" role="graphics-symbol" aria-labelledby="title-tb02-dark desc-tb02-dark">
                  <title id="title-tb02-dark">Icon title</title>
                  <desc id="desc-tb02-dark">A more detailed description of the icon</desc>
            ...
            <li>
              <a href="javascript:void(0)" className="transition-colors duration-300 hover:text-emerald-500">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 48 48" height="16" width="16" className="w-4 h-4 shrink-0" role="graphics-symbol" aria-labelledby="title-tb03-dark desc-tb03-dark">
                  <title id="title-tb03-dark">Icon title</title>
                  <desc id="desc-tb03-dark">A more detailed description of the icon</desc>
